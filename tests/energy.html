...
<body>
  ...
  <header>
    ...
    <p class="subtitle">12문항 · 5단계 상태라벨 · 즉시 실행 리마인드</p>
  </header>
  ...
  <main class="test">
    ...
    <!-- 취미 카테고리 테마 (hobby) 적용 -->
    <section class="card-q hobby" id="card">
      ...
      <p class="note">* 0~4 중 하나를 선택하세요 (보통=2). 자기보고식 경향 파악이며, 임상 진단이 아닙니다.</p>
    </section>
  ...
  <!-- 테스트 로직 -->
  <script src="../js/energy.js?v=2025.2" defer></script>
</body>
</html>