...
(function(){
  ...
  function classifyBoundary(n){
    const b=n.B, s=n.S, nn=n.N, k=n.K;
    // 우선 규칙
    ...
    // 근소차/중간대 → FLEX
    // 단, 아주 평평하면(분산 낮음) FLEX, 아니면 상위2축 하이브리드 제한 없이 FLEX 유지
